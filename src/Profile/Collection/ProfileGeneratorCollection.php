...
{
    public function __construct(private readonly ProfileFactory $profileFactory, private readonly AdrianeConfig $config, private readonly ProfileFilter $filter)
    {
    }
